...
to_view_2 <-  mexico_c2 %>% 
  ...
  mutate(
    source_vegetation_class = source_veg_class_table$source_veg_class_EN[match(mexico_c2$source_veg_class, source_veg_class_table$source_veg_class_std_ES)],
